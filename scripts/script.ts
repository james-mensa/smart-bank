...
const resultHex = "0x00000000000000000000000000000000000000000000000029a2241af62c0000";
...
async function getBalanceWithSignerAsOptional(accountId: number,signer?: number ) {
  try {
